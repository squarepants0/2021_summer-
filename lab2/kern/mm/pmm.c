...
// virtual address of boot-time page directory 页目录虚物理地址
pde_t *boot_pgdir = NULL;
// physical address of boot-time page directory 页目录物理地址
uintptr_t boot_cr3;
 ...
 * vpd is set bellow.
 * VPT 虚拟页表地址：0xFAC00000 前20位：0b11111010110000000000
 * VPD 页目录线性地址
 * */
